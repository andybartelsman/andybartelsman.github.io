...
//4 -> RGB + , alpha donde 0 es transparente y 255 es opaco

//variables
//las variables son espacios en la memoria del computador
//donde podemos almacenar datos
//primero, tenemos que decirle al computador que la variable
//existe, esto se llama DECLARAR y solo se hace una vez
var diametro;
...
//las funciones tambien se DECLARAN UNA VEZ
...
function miElipse() {
  ...
  //aqui dibujamos una elipse en las coordenadas 
  //ellipse(posX,posY, width, height);
  ellipse(mouseX, mouseY, diametro, diametro);
}

//declarar funcion miTriangulo()
